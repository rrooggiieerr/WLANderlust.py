						<tr>
							...
							<td><input type="text" id="L2TP_username" name="username" value="{{get('username', '')}}" autocomplete="off"/></td>
						</tr>
						<tr>
							<td><label for="L2TP_hostname">Server Hostname</label></td>
							<td><input type="text" id="L2TP_hostname" name="hostname" value="{{get('hostname', '')}}" autocomplete="off"/></td>
						</tr>
						<tr>
