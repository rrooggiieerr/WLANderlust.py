						<tr>
							...
							<td><input type="text" id="IPsec_username" name="username" value="{{get('username', '')}}" autocomplete="off"/></td>
						</tr>
						<tr>
							<td><label for="IPsec_hostname">Server Hostname</label></td>
							<td><input type="text" id="IPsec_hostname" name="hostname" value="{{get('hostname', '')}}" autocomplete="off"/></td>
						</tr>
						<tr>
							<td><label for="IPsec_password">Password</label></td>
							<td><input type="password" id="IPsec_password" name="password" value="{{get('password', '')}}" autocomplete="off"/></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="password" name="sharedsecret" value="{{get('sharedsecret', '')}}"{{' disabled' if defined('serverauthmethod') and serverauthmethod != 'sharedsecret' else ''}} autocomplete="off"/></td>
						</tr>
						<tr>
